...
<div class="wrap about-wrap">
    <h1><?php esc_html_e( 'Redux Framework - Extensions', 'fuse-wp' ); ?></h1>

    <div
        class="about-text"><?php printf( esc_html__( 'Supercharge your Redux experience. Our extensions provide you with features that will take your products to the next level.', 'fuse-wp' ), $this->display_version ); ?></div>
    <div
        class="redux-badge"><i
    ...
    <p class="about-description"><?php esc_html_e( "While some are built specificially for developers, extensions such as Custom Fonts are sure to make any user happy.", 'fuse-wp' ); ?></p>
