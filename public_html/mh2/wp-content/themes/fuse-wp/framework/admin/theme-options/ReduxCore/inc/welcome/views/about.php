<div class="wrap about-wrap">
    <h1><?php printf( esc_html__( 'Welcome to Redux Framework %s', 'fuse-wp' ), $this->display_version ); ?></h1>

    <div
        class="about-text"><?php printf( esc_html__( 'Thank you for updating to the latest version! Redux Framework %s is a huge step forward in Redux Development. Look at all that\'s new.', 'fuse-wp' ), $this->display_version ); ?></div>
    <div
        class="redux-badge"><i
    ...
    <div id="redux-message" class="updated">
        <h4><?php esc_html_e( 'What is Redux Framework?', 'fuse-wp' ); ?></h4>
        ...
        <p><?php esc_html_e( 'Redux Framework is the core of many products on the web. It is an option framework which developers use to
            enhance their products.', 'fuse-wp' ); ?></p>

        <p class="submit">
            <a class="button-primary" href="<?php echo 'http://';?>reduxframework.com"
               target="_blank"><?php esc_html_e( 'Learn More', 'fuse-wp' ); ?></a>
        </p>
    </div>

    <div class="changelog">

        <h2><?php esc_html_e( 'New in this Release', 'fuse-wp' ); ?></h2>
