    ...
    class Redux_Welcome {
        ...
        public function support_hash() {
            ...
            if ( ! empty( $data['identifier'] ) ) {
                ...
                $return['status']  = "error";
                $return['message'] = esc_html__( "Support hash could not be generated. Please try again later.", 'fuse-wp' );
            }
        ...
        public function admin_menus() {
            ...
            // About Page
            $page(
                esc_html__( 'Welcome to Redux Framework', 'fuse-wp' ), esc_html__( 'Redux Framework', 'fuse-wp' ), $this->minimum_capability, 'redux-about', array(
                    $this,
                    'about_screen'
                )
            );
            ...
            // Changelog Page
            $page(
                esc_html__( 'Redux Framework Changelog', 'fuse-wp' ), esc_html__( 'Redux Framework Changelog', 'fuse-wp' ), $this->minimum_capability, 'redux-changelog', array(
                    $this,
                    'changelog_screen'
                )
            );
            ...
            // Support Page
            $page(
                esc_html__( 'Get Support', 'fuse-wp' ), esc_html__( 'Get Support', 'fuse-wp' ), $this->minimum_capability, 'redux-support', array(
                    $this,
                    'get_support'
                )
            );
            ...
            // Support Page
            $page(
                esc_html__( 'Redux Extensions', 'fuse-wp' ), esc_html__( 'Redux Extensions', 'fuse-wp' ), $this->minimum_capability, 'redux-extensions', array(
                    $this,
                    'redux_extensions'
                )
            );
            ...
            // Credits Page
            $page(
                esc_html__( 'The people that develop Redux Framework', 'fuse-wp' ), esc_html__( 'The people that develop Redux Framework', 'fuse-wp' ), $this->minimum_capability, 'redux-credits', array(
                    $this,
                    'credits_screen'
                )
            );
            ...
            // Status Page
            $page(
                esc_html__( 'Redux Framework Status', 'fuse-wp' ), esc_html__( 'Redux Framework Status', 'fuse-wp' ), $this->minimum_capability, 'redux-status', array(
                    $this,
                    'status_screen'
                )
            );
        ...
        public function tabs() {
            ...
            <h2 class="nav-tab-wrapper">
                <a class="nav-tab <?php echo $selected == 'redux-about' ? 'nav-tab-active' : ''; ?>"
                    ...
                    <?php esc_html_e( "What's New", 'fuse-wp' ); ?>
                    ...
                    <?php esc_html_e( 'Extensions', 'fuse-wp' ); ?>
                    ...
                    <?php esc_html_e( 'Changelog', 'fuse-wp' ); ?>
                    ...
                    <?php esc_html_e( 'Credits', 'fuse-wp' ); ?>
                    ...
                    <?php esc_html_e( 'Support', 'fuse-wp' ); ?>
        ...
        public function contributors() {
            ...
            foreach ( $contributors as $contributor ) {
                ...
                $contributor_list .= sprintf( '<a href="%s" title="%s" target="_blank">', esc_url( 'https://github.com/' . $contributor->login ), esc_html( sprintf( esc_html__( 'View %s', 'fuse-wp' ), $contributor->login ) )
                );
